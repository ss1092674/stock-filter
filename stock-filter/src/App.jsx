...
function App() {
  ...
  const fetchData = () => {
    fetch("https://stock-filter-3ue4.onrender.com/signals")
      .then(res => {
  ...
  useEffect(() => {
    fetch("https://stock-filter-3ue4.onrender.com/watchlist")
      .then(res => res.json())
      .then(data => {
  ...
  const removeStock = (stock) => {
    fetch(`https://stock-filter-3ue4.onrender.com/watchlist/${stock}`, {
      method: "DELETE"
    })
      .then(res => res.json())
      .then(setWatchlist);
            ...
            <div className="card timeframe-selector">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  fetch("https://stock-filter-3ue4.onrender.com/set-interval", {
                    method: "POST",
                    headers: {
                      "Content-Type": "application/json"
                    },
